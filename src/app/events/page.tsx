...
function EventsPageContent({ user }: { user: User | null }) {
        ...
        <div className="flex-1 space-y-8 p-4 md:p-8">
            <div className="flex flex-col items-center text-center space-y-2">
                ...
                <p className="text-muted-foreground max-w-2xl">
                    Stay up-to-date with all our upcoming services, gatherings, and special events. Find your place and get involved!
                </p>
            </div>
                        ...
                        <Card key={event.id} className="border-border/50 flex flex-col hover:shadow-lg hover:border-primary/30 transition-all overflow-hidden">
                            ...
                            <CardFooter>
                                {user ? (
                                    ...
                                    <Button asChild className="w-full" variant="outline"><Link href="/login">Login to RSVP</Link></Button>
                                )}
                            </CardFooter>
                        </Card>
                    ))
